...
//		String companyName = getContactCompanyName("Chicago Bruner");
		
		String PhoneNumber = getContactPhone("Abel Kainan");
	...
	public static void selectMultipleSameContacts(String contactName) {
		List<WebElement> contactsChecks = driver.findElements(
				By.xpath("//a[text()='" + contactName + "']/parent::td/preceding-sibling::td/input[@type='checkbox']"));
	...
	public static String getContactPhone(String contactName) {
		return driver
				.findElement(By.xpath(
						"//a[text()='"+contactName+"']/parent::td/following-sibling::td[2]/span[@context='phone']"))
				.getText();
	}
