...
//				select#Form_getForm_Country  option:nth-child(4n)
		...
		// comma in css:
		List<WebElement> mandatoryEles = driver
				.findElements(By.cssSelector("input#username, input#password, input#remember, button#loginBtn"));
